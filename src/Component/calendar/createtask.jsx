...
export default function TaskForm() {
  ...
  return (
    <div className="max-w-sm mx-auto p-6 bg-white rounded-md shadow-md">
      ...
      {/* Note Input */}
      <div className="mb-4">
        <label className="block text-gray-500 mb-1">Add Note–</label>
        <input
          type="text"
          placeholder="e.g., I have a meeting at 11 a.m."
      ...
      <div className="flex justify-end items-center gap-6 text-sm font-semibold">
        ...
        <button className="text-[#058CBF] hover:underline">Create</button>
      </div>
    </div>
  );
}
